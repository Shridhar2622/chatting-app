...
import { User, Mail, Lock, Sun, Moon, Loader2 } from "lucide-react";
...
function Signup() {
  ...
  return (
    ...
    >
      ...
      {/* Glassmorphism Card */}
      <div
        className={`relative w-[420px] backdrop-blur-xl rounded-3xl shadow-2xl p-8 flex flex-col gap-6 border transition-all duration-300 ${isDark
